    ...
    <div class="col-12 md:col-6 lg:col-4">
      <Panel header="Tasks" style="height: 100%">
        <ul class="task-list">
          ...
          <li>
            <Checkbox v-model="tasksCheckbox" name="task" value="invoices" />
          ...
          <li>
            <Checkbox v-model="tasksCheckbox" name="task" value="flight" />
      ...
      <Panel header="Activity" style="height: 100%">
        ...
        <ul class="activity-list">
          <li>
            ...
            <ProgressBar :showValue="false" :value="95" />
          </li>
          <li>
            <div class="flex justify-content-between align-items-center mb-3">
            ...
            <ProgressBar :showValue="false" :value="24" />
          </li>
        </ul>
      </Panel>
    </div>
